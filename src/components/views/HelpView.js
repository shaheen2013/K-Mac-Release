            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://klevere.ai')}>
                            🌐 Official Website
                        </div>
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://github.com/klevere/klevere')}>
                            📂 GitHub Repository
                        </div>
